...
ENT.PrintName		= "Shield Generator (Blue)"
...
function ENT:SetupDataTables()
	self:NetworkVar("Bool",0,"Enable", { KeyName = "shbenabled", Edit = { type = "Boolean", order = 1, min = 0, max = 1 } } )
	self:NetworkVar("Int",0,"HP", { KeyName = "shbhp", Edit = { type = "Int", order = 4, min = 1, max = 5000000 } } )
	self:NetworkVar("Float",0,"ShieldSize", { KeyName = "shbradius", Edit = { type = "Float", order = 3, min = 5, max = 200 } } )
	self:NetworkVar("Bool",1,"BlockerExists")
	self:NetworkVar("Bool",2,"IsRecharging")
	self:NetworkVar("Bool",3,"IsUseable", { KeyName = "shbuseable", Edit = { type = "Boolean", order = 2, min = 0, max = 1 } } )
...
function ENT:CreateBlocker()
	...
	self.Blocker:SetPos(self:GetPos()-self:GetUp()*25)
	self.Blocker:SetAngles(self:GetAngles())
