...
ENT.PrintName		= "Shield Generator (Red) (Invincible)"
...
function ENT:SetupDataTables()
	self:NetworkVar("Bool",0,"Enable", { KeyName = "shrienabled", Edit = { type = "Boolean", order = 1, min = 0, max = 1 } } )
	self:NetworkVar("Float",0,"ShieldSize", { KeyName = "shriradius", Edit = { type = "Float", order = 3, min = 5, max = 200 } } )
	self:NetworkVar("Bool",1,"BlockerExists")
	self:NetworkVar("Bool",2,"IsRecharging")
	self:NetworkVar("Bool",3,"IsUseable", { KeyName = "shriuseable", Edit = { type = "Boolean", order = 2, min = 0, max = 1 } } )
